    ...
    <div className="min-h-screen bg-[#FBF7F0] flex items-center justify-center px-4 py-20">
      <div className="w-full flex flex-col items-center gap-6">
        <div className="text-center">
          ...
          <h1 className="font-heading text-2xl font-bold text-[#1B3A2D]">Welcome back</h1>
          <p className="font-body text-sm text-[#1B3A2D]/50 mt-1">Sign in to your World of Mysore Pak account</p>
        </div>
        <SignIn />
      </div>
    </div>
